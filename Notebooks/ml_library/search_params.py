...
# (param1, param2, ...) --> score
if RESUME:
    with open('./tmp/search_params_result.p', 'rb') as f:
        results = pickle.load(f)

    with open('./tmp/search_params_acc_hist.p', 'rb') as f:
